  ...
  return (
    <div className="bg-gray-50 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-3xl p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        {/* --- REVISI: TAMBAHAN ALERT KAK --- */}
        <div
          className="bg-orange-50 border-l-4 border-orange-500 p-4"
          role="alert"
        >
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-orange-800">
                <strong className="font-bold">PERHATIAN:</strong> Sebelum
                membuat PKS, pastikan sudah tersedia{" "}
                <strong>Dokumen KAK (Kerangka Acuan Kerja)</strong> yang telah
